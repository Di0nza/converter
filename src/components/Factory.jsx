                        ...
                        <group name="Object_2">
                            <group name="RootNode">
                                <group name="charecter_1"
                                    ...
                                    <mesh castShadow receiveShadow name="charecter_1_Rez01palette_0"
                                          geometry={nodes.charecter_1_Rez01palette_0.geometry}
                                          material={materials.Rez01palette}/>
                                </group>
                                <group position={[23.75, 50.025, -105.227]}>
                                    <pointLight intensity={15} color={0xFFD700} distance={4.5} />
                                </group>
                                <group name="BTC01_4"
                                       position={[23.75, 50.025, -100.227]}>
                                    <pointLight intensity={4} color={0xFFD700} distance={2.5}/>
                                    <mesh castShadow receiveShadow name="BTC01_4_Rez01palette_0"
                                          geometry={nodes.BTC01_4_Rez01palette_0.geometry}
                                          material={materials.Rez01palette}/>

                                </group>
                                <group castShadow receiveShadow name="BTC01_3"
                                       position={[23.75, 50.025, -100.227]}>
                                    <pointLight intensity={4} color={0xFFD700} distance={2.5}/>
                                ...
                                <group name="BTC01_2"
                                       position={[23.75, 50.025, -100.227]}>
                                    <pointLight intensity={4} color={0xFFD700} distance={2.5} />
                                    <mesh castShadow receiveShadow name="BTC01_2_Rez01palette_0"
                                ...
                                <group name="BTC01"
                                       position={[23.75, 50.025, -100.227]}>
                                    <pointLight intensity={4} color={0xFFD700} distance={2.5} />
                                    <mesh castShadow receiveShadow name="BTC01_Rez01palette_0"
                                ...
                                <group name="BTC00"
                                    ...
                                    <pointLight intensity={4} color={0xFFD700} distance={2.5} />
                                    <mesh castShadow receiveShadow name="BTC00_Rez01palette_0"
                                ...
                                <group name="BTC0"
                                    ...
                                    <pointLight intensity={4} color={0xFFD700} distance={2.5} />
                                    <mesh castShadow receiveShadow name="BTC0_Rez01palette_0"
                                          geometry={nodes.BTC0_Rez01palette_0.geometry}
                                          material={materials.Rez01palette}/>
                                </group>
                                <group name="roll01"
                                       position={[-108.75, 53.75, -96.25]}>
                                    <mesh castShadow receiveShadow name="roll01_Rez01palette_0"
                                ...
                                <group name="roll02"
                                    ...
                                    <mesh castShadow receiveShadow name="roll02_Rez01palette_0"
                                          geometry={nodes.roll02_Rez01palette_0.geometry}
                                          material={materials.Rez01palette}/>
                                </group>
                                <group name="Interior_new">
                                    <mesh castShadow receiveShadow name="Interior_new_Rez01palette_0"
                                          geometry={nodes.Interior_new_Rez01palette_0.geometry}
                                          material={materials.Rez01palette}/>
                                </group>
                                <group name="polySurface30">

                                    <mesh castShadow receiveShadow name="polySurface30_Rez01palette_0"
                                ...
                                <group name="Null_4" position={[0, 0, -7.4]}>
                                    <group name="money_drop02"
                                        ...
                                        <mesh castShadow receiveShadow name="money_drop02_Rez01palette_0"
                                ...
                                <group name="Null_2" position={[0, 0, -7.4]}>
                                    <group name="money_drop02_2"
                                        ...
                                        <mesh castShadow receiveShadow name="money_drop02_2_Rez01palette_0"
                                ...
                                <group name="Null_3"
                                    ...
                                    <group name="money_drop02_3"
                                           ...
                                           rotation={[0, 0, Math.PI / 2]}>
                                        <mesh castShadow receiveShadow name="money_drop02_3_Rez01palette_0"
                                ...
                                <group name="Null_1"
                                    ...
                                    <group name="money_drop02_4"
                                           ...
                                           rotation={[0, 0, Math.PI / 2]}>
                                        <mesh castShadow receiveShadow name="money_drop02_4_Rez01palette_0"
                                ...
                                <group name="Null">
                                    <group name="money_drop01"
                                           ...
                                           rotation={[0, 0, -2.531]}>
                                        <mesh castShadow receiveShadow name="money_drop01_Rez01palette_0"
                                              geometry={nodes.money_drop01_Rez01palette_0.geometry}
                                              material={materials.Rez01palette}/>
                                    </group>
                                </group>
                                <group position={[-165.836, 129.574, -92.5]}>
                                    <pointLight intensity={3} color={0x00FF00} distance={0.7} />
                                </group>
                            </group>
                        </group>
                    </group>
